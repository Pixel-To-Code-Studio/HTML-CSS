...
Hi new student, welcome to the curriculum! In this document you'll find all the instructions you need in order to prepare yourself for your journey while following this curriculum, and beyond!
...
![slack logo](../_media/slack-logo.png)
...
- [App store](https://apps.apple.com/gb/app/slack/id803453959?mt=12)
- [Google Play](https://play.google.com/store/apps/details?id=com.Slack&hl=en-gb)
...
- [Cheat sheet for basics and shortcuts](https://slack.com/intl/en-gb/help/articles/201374536-Slack-keyboard-shortcuts)
...
![vscode logo](../_media/vscode-logo.png)
...
- [VSCode Tips](https://github.com/Pixel-To-Code-Studio/fundamentals/tree/master/VSCodeTips)

### What's the way to submit my homework? Use planning tool Trello

<br/>
<a href="http://www.youtube.com/watch?feature=player_embedded&v=tVooja0Ta5I" target="_blank"><img src="../_media/trello-logo.png" alt="Trello Video" /></a><br/>

Trello is a planning tool that allows you to make todo lists in order to organize and prioritize your projects. When following this course we'll use it to submit your homework for the first module. Before you start your first class, please do the following:
...
<a href="http://www.youtube.com/watch?feature=player_embedded&v=w3jLJU7DT5E" target="_blank"><img src="./../_media/github-logo.png" alt="GitHub Video" /></a>
...
> If the answer to this is 'no', don't panic. First try and see if you can find some information about the above tools yourself (hint: ask Google first). If that doesn't work, don't be shy to ask your classmates or anyone from Pixel To Code Studio on what to do next.
...
Before getting technical, please read about the Pixel To Code Studio culture [here](https://github.com/Pixel-To-Code-Studio/culture) and also check [these scenarios](https://github.com/Pixel-To-Code-Studio/culture/blob/main/scenarios.md) that will give you a hint on how we work. The first or second week of the course, there will be a collaborative session with your whole class to discuss all of this.

Now, with that out of the way we can get started with the readings for the first week. You can find that [here](../Week1/). Make sure you've finished it before your first class on Friday!
