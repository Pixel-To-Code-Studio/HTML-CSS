...
```html
<div style="background-color: blue;">Pixel To Code Studio is awesome!</div>
```
...
In your course journey you'll mainly be using **Google Chrome** when developing, as is has great developer tools that allow us to develop web applications in an easier and clearer way.
